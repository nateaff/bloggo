...
When I was introduced to fractal(or fractional) dimension it was in the abstract setting of sets. Sometimes fractal dimension is also lumped into the category of nonlinear features that are associated with dynamical systems. There is a more direct relation, though, to more familiar statistical properties of random processes. On top of that, changes in fractal dimension are fairly easy to identify in the graph of a function. At the end I'll do a quick simulation to show that fractal dimension is also useful for discriminating between time series with similar features.
...
t1 <- replicate(reps, arima.sim(n = 500, list(ar = c(0.7, -0.2), ma = c(-5, 0, 5))))
