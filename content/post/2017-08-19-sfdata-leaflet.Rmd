...
For doing something other than downloading the complete dataset we need to build an SoQL query. The `soql` package simplifies this step by providing functions for forming basic select queries. The query could also be written by hand, and the code below shows what that SQL-like syntax looks like. 
