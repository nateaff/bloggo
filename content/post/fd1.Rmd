...
When I was introduced to fractal(or fractional) dimension it was in the abstract setting of sets. In applied contexts, I have also seen fractal dimension lumped into the category of nonlinear features that are associated with dynamical systems. Fractal dimension can, more intuitively, be thought as describing the local roughness of a graph. This makes changes in fractal dimension when isolated from other properties, fairly easy to identify in the graph of a function, or random process. On top of that, the fractal dimension of random process can be described in terms of the autocorrelation function of a time series. This links fractal dimension to a more familiar statistical concept.

Roughly speaking, fractal dimension measures a relation of points that are close to each other in the time series: it describes a property of the time series that holds at the finest resolution. In contrast to this local property, the Hurst parameter is a global property of a time series, a measure of the relation between points in a time series that are distant from each other. 
